...
businessRouter.delete(
  "/me/socials/:id",
  authenticate,
  businessController.removeSocial,
);
...
businessRouter.delete(
  "/me/bank-details/:id",
  authenticate,
  businessController.removeBankDetails,
);

businessRouter.get(
  "/me/payment-link",
  authenticate,
  paymentController.getGenericPaymentLink,
);
businessRouter.get(
  "/me/payment-links/quick",
  authenticate,
  paymentController.listQuickLinks,
);
businessRouter.post(
  "/me/payment-links/quick",
  authenticate,
  paymentController.createQuickLink,
);
businessRouter.delete(
  "/me/payment-links/quick/:id",
  authenticate,
  paymentController.deleteQuickLink,
);
...
businessRouter.post(
  "/me/services",
  authenticate,
  paymentController.createService,
);
businessRouter.patch(
  "/me/services/:id",
  authenticate,
  paymentController.updateService,
);
businessRouter.delete(
  "/me/services/:id",
  authenticate,
